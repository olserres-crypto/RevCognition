    ...
    <section className="bg-[var(--color-surface)] py-16 sm:py-24">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="max-w-2xl">
          ...
          <h2 className="text-3xl sm:text-4xl text-[var(--color-ink)] mb-6">
            {t("heading")}
          </h2>
        ...
        <p className="mt-12 font-light text-3xl sm:text-5xl lg:text-6xl text-[var(--color-ink)] leading-[1.05] tracking-tight max-w-3xl">
          {t("closingPre")}{" "}
